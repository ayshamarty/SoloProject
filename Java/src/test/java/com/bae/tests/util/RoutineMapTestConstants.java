...
public class RoutineMapTestConstants {
	...
	public static final String TESTROUTINE1STR = "{\"routineID\":1,\"routineName\":\"Sun Salutation\",\"routineType\":\"Warm Up\",\"poseSet\":[]}";
	public static final Routine TESTROUTINE2 = new Routine(2, "Moon Salutation", "Cool Down");
	public static final String TESTROUTINE2STR = "{\"routineID\":2,\"routineName\":\"Moon Salutation\",\"routineType\":\"Cool Down\",\"poseSet\":[]}";
